...
public class ResultTableController {
    ...
    @FXML
    private Tab tab_homeostasis;

    @FXML
    private Tab tab_rating;

    @FXML
    private Tab tab_reliability;

    @FXML
    private Tab tab_water_protection;
    ...
    @FXML
    private TextField waterproofFunctionResource_experimental_1;

    @FXML
    private TextField waterproofFunctionResource_experimental_2;
